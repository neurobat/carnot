...
T=Tcp_PG';
Z=0;
cp_PG_F0 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.1;
cp_PG_F01 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.2;
cp_PG_F02 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.3;
cp_PG_F03 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.4;
cp_PG_F04 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.5;
cp_PG_F05 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
Z=0.6;
cp_PG_F06 = 4.47642 + 0.60863*Z + (-0.71497)*273.15./T + (-1.93855)*Z*273.15./T + 0.47873*(273.15./T).^2;
