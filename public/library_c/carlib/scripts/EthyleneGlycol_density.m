function [fitresult, gof] = EthyleneGlycol_density(rho_PG_T, rho_PG_D)
...
Trho_EG = [-50:5:200]+273.15;
T=Trho_EG';
Z=0;
rho_EG_F0 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.1;
rho_EG_F01 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.2;
rho_EG_F02 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.3;
rho_EG_F03 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.4;
rho_EG_F04 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.5;
rho_EG_F05 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
Z=0.6;
rho_EG_F06 = 658.49825 + (-54.81501)*Z + 664.71643*273.15./T + 232.72605*Z*273.15./T + (-322.61661)*(273.15./T).^2;
...
Tf = (1 - 0.06982*Xi - 0.3578*Xi.*Xi)*273.15;
Tf_C=Tf-273.15; %in °C
rho_EG_Tf = 658.49825 + (-54.81501)*Xi + 664.71643*273.15./Tf + 232.72605*Xi*273.15./Tf + (-322.61661)*(273.15./Tf).^2;

            
%% Plot fit with data.
%subplot( 2, 1, 1 );
plot(Trho_EG-273.15,rho_EG_F06,'k')
hold on
plot(Trho_EG-273.15,rho_EG_F05,'--g')
plot(Trho_EG-273.15,rho_EG_F04,'--b')
plot(Trho_EG-273.15,rho_EG_F03,'--r')
plot(Trho_EG-273.15,rho_EG_F02,'g')
plot(Trho_EG-273.15,rho_EG_F01,'b')
plot(Trho_EG-273.15,rho_EG_F0,'r')
plot(Trho_EG-273.15,rho_PG_carF06,'k-o');
plot(Trho_EG-273.15,rho_PG_carF0,'r-o');
plot(Tf_C,rho_EG_Tf,'m-d','linewidth',1.5);
plot(fitresult, xData, yData,'k-s');
title('Ethyleneglycole Source: M. Conde Engineering 2011');
